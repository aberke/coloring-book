...
=======
    ...
    */
    ...
    // TODO: Clean up naming conventions + uses of these functions.
    return {
        drawMirrorLines: drawMirrorLines,

        slantedSlices: slantedSlices,

        petalEllipse: petalEllipse,
        petalsEllipseWithDiamondPath: petalsEllipseWithDiamondPath,

        getFundamentalDomainLineSlices: getFundamentalDomainLineSlices,

        getCatmullRomPath: getCatmullRomPath,

        trianglePath: trianglePath,
        trianglesPath2: trianglesPath2,
        trianglesPath3: trianglesPath3,
        trianglesPath4: trianglesPath4,
        // TODO: Remove the need to export trianglesPath.
